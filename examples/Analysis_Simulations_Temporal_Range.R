...
data1 <- as.data.frame(read_excel("data/Vecchia_ST_Simulation_TEMPORAL_RANGES5_20191107.xlsx", 
...
xyt <- as.matrix(read_excel("data/Vecchia_ST_Simulation_TEMPORAL_RANGES5_20191107.xlsx", 
                            sheet = "xy", col_names = FALSE))


# Read in the test set data 
xy_test <- as.matrix(read_excel("data/Vecchia_ST_Simulation_TEMPORAL_RANGES5_test_20191107.xlsx", 
                                sheet = "1", col_names = FALSE))

test_xyt <- as.matrix(read_excel("data/Vecchia_ST_Simulation_TEMPORAL_RANGES5_test_20191107.xlsx", 
                                 sheet = "xy", col_names = FALSE))
...
for (i in 1:20){
  ...
  Ydata <- read_excel("data/Vecchia_ST_Simulation_TEMPORAL_RANGES5_20191107.xlsx", 
                      sheet = as.character(i), col_names = FALSE)
  
  test_data <- read_excel("data/Vecchia_ST_Simulation_TEMPORAL_RANGES5_test_20191107.xlsx", 
                          sheet = as.character(i), col_names = FALSE)
  ...
  save(Local.Kriging.MSE,Local.Kriging.crps,Local.Kriging.logs,
       ...
       LURK.Vecchia.MSE,LURK.Vecchia.crps,LURK.Vecchia.logs,LURK.Vecchia.beta.estimates,
