...
test_that("Invalid locs input", {
  ...
  expect_error(prestogp_fit(model, as.matrix(1:3), as.matrix(1:3), 1:3),
...
test_that("Simulated dataset multivariate spatial", {
    ...
    expect_equal(beta.out, c(0, 0.95, 0.93, 0.92, 0.88, rep(0, 6), 0.56,
                             0.7, 1.12, 1, rep(0, 6), 0.94, 0.85,
                             1.03, 0.94, rep(0, 6)), tolerance=0.06)
