...
ny <- 2 # number of response variables
p <- 10 # number of predictors for each response
p.nz <- 4 # number of nonzero predictors for each y
n.spatial.xy <- 7 # number of spatial coordinates per dimension
...
rm(ny, p, p.nz, n.spatial.xy, beta1, i, j, Sigma.X, mean.trend.st, n.rho,
